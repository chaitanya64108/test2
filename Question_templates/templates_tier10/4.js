...
(function(){
  ...
  H.vars('sq_est_between',[
    ...
    function(){ var a=rint(3,20), num=a*a+a, ans='Closer to '+(a+1); var w=['Closer to '+a,'Exactly midway','Closer to '+(a+2)]; var sol=buildSqEstBetweenV2Solution(a,num); return {question:tri('Is '+K(RT(num))+' closer to '+a+' or to '+(a+1)+'?',K(RT(num))+' '+a+' ke kareeb hai ya '+(a+1)+' ke?',K(RT(num))+' '+a+' के निकट है या '+(a+1)+' के?'),ans:ans,w:w,solution:sol}; },
